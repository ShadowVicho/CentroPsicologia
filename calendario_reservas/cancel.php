        ...
        try {
            ...
            $mail->Body = "
                ...
                <body>
                    ...
                    <p>Tu cita para el día <strong>{$reservation['fecha_reserva']}</strong> ha sido cancelada.</p>
            ...
            $mail->Body = "
                ...
                <body>
                    ...
                    <p>El cliente <strong>{$reservation['nombre']} {$reservation['apellido']}</strong> ha cancelado su cita para el día <strong>{$reservation['fecha_reserva']}</strong>.</p>
                </body>
                </html>
            ";
            $mail->send();

            echo "Cita cancelada. Se ha enviado un correo de cancelación.";
        } catch (Exception $e) {
